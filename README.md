...
<b>Note:</b> If you are not using `Paru` as your AUR helper, you will need to change the AUR helper in `~/.config/polybar/scripts/updates` for the Updates indicator on the polybar to work.
</details>
